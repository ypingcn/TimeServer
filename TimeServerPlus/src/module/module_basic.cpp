...
{
  tsp_module_t value = {
    { regex("^.*$"),string("GET"),string("HTTP/1.1") },tsp_module_basic_get,10
  };
  v.push_back(value);

  value = {
    { regex("^.*$"),string("HEAD"),string("HTTP/1.1") },tsp_module_basic_head,10
  };
  v.push_back(value);

  value = {
    { regex("^.*$"),string("OPTIONS"),string("HTTP/1.1") },tsp_module_basic_options,10
  };
  v.push_back(value);

  value = {
    { regex("^.*$"),string("PUT"),string("HTTP/1.1") },tsp_module_basic_put,10
  };
  v.push_back(value);

  value = {
    { regex("^.*$"),string("POST"),string("HTTP/1.1") },tsp_module_basic_post,10
  };
  v.push_back(value);

  value = {
    { regex("^.*$"),string("DELETE"),string("HTTP/1.1") },tsp_module_basic_delete,10
  };
  v.push_back(value);
}
